...
// select page with search criterium on www.autoscout24.nl  and put the link in the $pageurl variable And replace pagenumber after page= in the link with {$page_counter}

$pageurl = "http://www.autoscout24.nl/ListGN.aspx?brdcrmb=color&vis=1&state=A&atype=C&make=74&model=15734&version=maxi&fuel=D&pricefrom=1000&cy=NL&page={$page_counter}&maxRes=20&results=20&ustate=N,U&sort=price&rfnl=True&mmvco=1&mmvmk0=74&mmvmd0=15734";

//maxi zilver,grijs    $pageurl = "http://www.autoscout24.nl/ListGN.aspx?vis=1&state=A&atype=C&make=74&model=15734&version=maxi&fuel=D&pricefrom=1000&bcol=6%2c12&cy=NL&page={$page_counter}&results=20&ustate=N%2cU&sort=price&rfnl=True&mmvco=1&mmvmk0=74&mmvmd0=15734&action=add&fbc=1";
